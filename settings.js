...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "6YoDUBqT#VBBoQSyTdjK472smsHul_LJSYjZ1jWJIpxsz8SZg5vo", // Add your session id
PREFIX: process.env.PREFIX || ".",
MODE: process.env.MODE || "public",  //public | private | inbox | group
OWNER_NUMBER: process.env.OWNER_NUMBER || "94750313394",
DEV: process.env.DEV || "94761081292",
